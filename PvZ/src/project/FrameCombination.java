...
public class FrameCombination {
    ...
    public static void init(){
        ...
        SUNFLOWER[0] = ImageLoader.load("/images/plants/frames/Sunflower/sunflower1.gif");
        SUNFLOWER[1] = ImageLoader.load("/images/plants/frames/Sunflower/sunflower2.gif");
