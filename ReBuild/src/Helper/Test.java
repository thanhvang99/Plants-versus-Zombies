...
public class Test {
    public static void setUp(){
        NormalZombie z1 = new NormalZombie(5,0,0);
        NormalZombie z2 = new NormalZombie(5,1,0);
        NormalZombie z3 = new NormalZombie(5,2,0);
        NormalZombie z4 = new NormalZombie(5,3,0);
